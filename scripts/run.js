...
const main = async () => {
    ...
    let wait = await txn.wait(); // txn.wait returns an object containing all data about the txn
    console.log("NEW EVENT CREATED", wait.events[0].event, wait.events[0].args);

    let eventID = wait.events[0].args.eventID;
    console.log("EVENT ID:", eventID);
    
    // Test 2: RSVP to an event
    ...
    // Test 3: confirm all of the RSVPs
    ...
    // Test 4: withdraw unclaimed deposits
